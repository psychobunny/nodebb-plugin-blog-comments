				...
				<div class="topic-body">
					<div class="topic-profile-pic">
						<a href="{relative_path}/user/{posts.userslug}">
							<img src="{posts.picture}" alt="{posts.username}" class="profile-image" title="{posts.username}">
						</a>
					</div>
					<div class="topic-text">
						<div class="post-content" itemprop="text"><small>{posts.username} commented {posts.timestamp}</small><br />{posts.content}</div>
					</div>
				</div>
			</div>
		</li>
